# USAGE
# python3 detect.py --encodings encodings.pickle
...
while True:
	...
	if guery == 1:
            ...
            cv2.imwrite('unknown_image_'+ str(datetime.datetime.now()) + '.png', frame)
            encoded_frame = base64.b64encode(frame)
            client.publish("faces/unknown", encoded_frame)

	if guery == 0:
            print("Found an image of us!")
            cv2.imwrite('us_image_'+ str(datetime.datetime.now()) + '.png', frame)
            encoded_frame = base64.b64encode(frame)
            client.publish("faces/us", encoded_frame)
